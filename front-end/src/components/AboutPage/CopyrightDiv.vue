      ...
      <n-space v-if="!showQR" class="copyright-text-content" :size="10" :vertical="true" justify="center" align="center">
        <n-space :size="30">
          ...
          <n-button color="#32647d" size="tiny" @click="goTo(bilibiliUrl ?? ``)" v-if="bilibiliUrl">
            {{ bilibiliText }}
            <template #icon>
              <n-icon v-html="bilibiliSvg"/>
            </template>
          </n-button>
          <n-button color="#32647d" size="tiny" @click="goTo(docsUrl ?? ``)" v-if="docsUrl">
            {{ docsButtonText }}
            <template #icon>
              <n-icon v-html="docsSvg"/>
            </template>
          </n-button>
